 ...
 * @author Nefonfo
 */
public class WorkbookManager implements IManager<Workbook> {
    ...
    @Override
    public List<Workbook> execute() throws Exception {
        this.query += ";";
        ...
        while(res.next()) {
            ...
            Workbook wb = new Workbook(id, us_id, name, content);
